 ...
 */
$(function(){
    $('.b-tabs__nav').horizontalNav();
    /*tabs*/
    $(".b-tabs__nav").tabs(".b-tabs__unit");
    $(".b-tabs__nav--product").tabs(".b-tabs__unit--product");
//    custom select
    $('select').selectBox();
//    rating init
    $('.b-rating-large').rating({
        fx: 'full',
        image: 'img/rating-large.png'
//        url: 'rating.php',
    });
    $('.b-rating-small').rating({
        fx: 'full',
        readOnly: true,
        image: 'img/rating-small.png'
//        url: 'rating.php',
    });
...
//    simple slider on main page
    $('.b-slider__viewport').orbit({
        bullets: true
    });
//slider on product page init
    $('.slider__thumbs').flexslider({
        animation: "slide",
        controlNav: false,
        animationLoop: false,
        slideshow: false,
        itemWidth: 105,
        itemMargin: 10,
        asNavFor: '.slider__viewport'
    });

    $('.slider__viewport').flexslider({
        animation: "slide",
        controlNav: false,
        animationLoop: false,
        slideshow: false,
